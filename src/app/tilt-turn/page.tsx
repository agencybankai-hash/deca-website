          ...
          items={[
            {
              ...
              alt: "DECA tilt & turn window — Profile Cross-Section",
            },
            {
              icon: (
                <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
              ...
              alt: "DECA tilt & turn window — Chamber Structure",
            },
            {
              icon: (
                <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
              ...
              alt: "DECA tilt & turn window — Triple Seal System",
            },
            {
              icon: (
                <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
              ...
              image: `${a}/components/components-5.webp`,
              alt: "DECA tilt & turn window — Hardware Detail",
            },
            {
              icon: (
                <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
              ...
              alt: "DECA tilt & turn window — Steel Reinforcement",
            },
          ]}
        />
      </Section>
